...
public class OpenLayersLayerDefinitionEntityMapper {
    ...
    public OpenLayersLayerDefinitionBO fromEntity(SqlViewLayerEntity entity, String workspaceName) {
        OpenLayersLayerDefinitionBO bo = new OpenLayersLayerDefinitionBO();
        bo.setId(entity.getId());
        bo.setWorkspaceName(workspaceName);
        bo.setServiceType(entity.getServiceType());
        ...
        bo.setOlStyleJson(entity.getOlStyleJson());
        return bo;
    }
}
